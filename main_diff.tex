...
%DIF ADD main_reviewed.tex    Mon May 13 11:05:12 2019
...
\title{Scalability Model for the LOFAR Direction Independent Pipeline}\author{ $^a$}
\ead{a@email.com}

\author{B $^b$}\author{C $^c$}\author{D $^{ad}$}\author{E$^e$}
\author{F$^a$}
...
\DIFadd{We have done several tests to determine the scalability of LOFAR processing with respect to several parameters. We outline our findings below as well as their implications for processing in context of the LOFAR surveys and other LOFAR projects. 
}
...
\DIFaddbegin \subsubsection{Comparison with production runs}
...
\begin{figure}
    \DIFaddbeginFL \includegraphics[width=0.9\linewidth]{figures/diffs.png}
